...
<input type="hidden" name="product_dtl_id" value="<?php echo $product_dtl_id; ?>" />
<input type="hidden" name="thickness" value="<?php echo $thickness; ?>" />
...
<table border="0" width="100%" class="ui-widget">
	<tr>
		<td>ข้อมูล ณ วันที่ : <strong><?php echo $theDate; ?></strong></td>
		<td align="right">
			<input type="button" name="mainButton" class="button mainButton" value="ย้อนกลับหน้าแรก"/>&nbsp;&nbsp;
			<input type="button" name="backButton" class="button backButton" value="ย้อนกลับ" onclick="onBack()"/>
...
<?= form_open("film/edit_film", array("id" => "search_form")) ?>
<input type="hidden" name="date" value="<?php echo $theDate; ?>" />
<input type="hidden" name="product_dtl_id" value="<?php echo $product_dtl_id; ?>" />
<input type="hidden" name="thickness" value="<?php echo $thickness; ?>" />
<input type="hidden" name="lot_no" value="<?php echo $lot_no; ?>" />
<?= form_close() ?>
